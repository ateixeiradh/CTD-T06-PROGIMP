...
// function pontuacaoGames(Alice, Bob) {
//     const pontosAlice = [23, 82, 46]

//     const pontosBob = [45, 8, 32]

//     for (i = 0; i < pontosAlice.length; i++) {

//         if (pontosAlice[0] > pontosBob[0]) {
...
// Numa construção de um IF sem o ELSE, o que acontece se o teste da condição do IF retornar FALSE?
